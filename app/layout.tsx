...
export const metadata: Metadata = {
  ...
  description:
    'Полный цикл видеопродакшна от разработки креативной концепции до публикации. Реклама, клипы, имиджевые видео. Обучение ИИ-генерации, съемке и монтажу.',
  keywords: [
    'видеопродакшн',
    'ИИ-генерация',
    'обучение видео',
...
export default function RootLayout({
  ...
  return (
    <html lang="ru" className="dark">
      <body className={`${saNoRules.variable} font-sans antialiased`}>{children}</body>
    </html>
  )
}
