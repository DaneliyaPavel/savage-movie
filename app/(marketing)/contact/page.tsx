  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="px-6 md:px-10 lg:px-20 pb-20">
        <form onSubmit={handleSubmit} className="max-w-4xl">
          ...
          >
            ...
            <div className="flex items-center justify-between mb-8">
              <label className="text-xs uppercase tracking-widest text-muted-foreground">{t("contact.budget")}</label>
        ...
        >
          <div>
            <h3 className="text-xs uppercase tracking-widest text-muted-foreground mb-4">{t("contact.emailLabel")}</h3>
            <a href="mailto:hello@savagemovie.ru" className="text-lg hover:text-accent transition-colors">
              hello@savagemovie.ru
            </a>
          </div>
          <div>
            <h3 className="text-xs uppercase tracking-widest text-muted-foreground mb-4">{t("contact.location")}</h3>
