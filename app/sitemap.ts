...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    {
      /*
       * Раздел направлений — хаб коммерческой архитектуры: с него расходится
       * трафик по production-территориям. Приоритет сравнялся с коммерческой
       * посадочной, потому что это вторая точка входа платного и органического
       * спроса, а не страница-перечисление.
       *
       * Отдельных городских копий (/uslugi-spb, /uslugi-moskva) здесь нет и
       * быть не должно — см. комментарий у /reklamny-rolik.
       */
