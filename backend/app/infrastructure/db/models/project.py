...
class Project(Base):
    ...
    mux_playback_id = Column(Text, nullable=True)  # Bunny Stream Video ID для видео
    carousel_gif_url = Column(Text, nullable=True)  # Bunny Video ID или URL для GIF в карусели на главной
