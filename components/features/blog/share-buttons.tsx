    ...
    >
      ...
      {buttons.map(btn => (
        <a
          ...
          title={btn.label}
          className="w-9 h-9 flex items-center justify-center border border-border/30 text-muted-foreground hover:text-[#ff2936] hover:border-[#ff2936]/30 transition-colors duration-300"
        >
          {btn.icon}
        </a>
      ))}
