---
name: seo-audit
description: Audits and diagnoses SEO issues on a site. Use when the user wants an SEO audit, technical SEO review, on-page SEO check, meta tags review, or asks "why am I not ranking," "SEO issues," or "SEO health check." For building pages at scale, use programmatic-seo. For structured data, use schema-markup.
---
...
- For AI writing detection patterns (em dashes, overused phrases, filler words), see [marketingskills repo](https://github.com/coreyhaines31/marketingskills/tree/main/skills/seo-audit/references) if needed.
- For AI search optimization (AEO, GEO, LLMO, AI Overviews), use the **ai-seo** skill.
...
- [Rich Results Test](https://search.google.com/test/rich-results) — use for schema validation (renders JavaScript)
...
- **ai-seo**: Optimizing content for AI search engines (AEO, GEO, LLMO)
