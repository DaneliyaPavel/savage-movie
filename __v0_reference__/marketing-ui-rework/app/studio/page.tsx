...
export default function StudioPage() {
  ...
  const TESTIMONIALS = [
    {
      quoteRu: "Работа с Savage подняла наш бренд-фильм на уровень, о котором мы даже не мечтали.",
      quoteEn: "Working with Savage elevated our brand film beyond anything we imagined.",
  ...
  const TEAM = [
    {
      ...
      roleRu: "Режиссёр",
      roleEn: "Director",
      image: "/portrait-professional-filmmaker-male.jpg",
    },
    {
      nameRu: "Мария Смирнова",
      nameEn: "Maria Smirnova",
      roleRu: "Режиссёр",
      roleEn: "Director",
      image: "/portrait-professional-filmmaker-female.jpg",
    },
    {
      nameRu: "Дмитрий Козлов",
      nameEn: "Dmitry Kozlov",
      roleRu: "Оператор",
      roleEn: "DP",
      image: "/portrait-cinematographer-male.jpg",
    },
    {
      ...
      roleRu: "Продюсер",
      roleEn: "Producer",
      image: "/portrait-film-producer-female.jpg",
    },
  ]
      ...
      <AnimatedSection className="px-6 md:px-10 lg:px-20 py-20 border-t border-border">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {TEAM.map((member, index) => (
            <HoverNote key={language === "ru" ? member.nameRu : member.nameEn} note={t("studio.viewReel")}>
              <motion.article
              ...
              >
                <div className="relative aspect-[3/4] rounded-sm overflow-hidden mb-4">
                  <Image
                    ...
                    alt={language === "ru" ? member.nameRu : member.nameEn}
                    fill
                    className="object-cover transition-transform duration-700 group-hover:scale-105 grayscale group-hover:grayscale-0"
                  />
                </div>
                <h3 className="text-lg font-light">{language === "ru" ? member.nameRu : member.nameEn}</h3>
                <p className="text-sm text-muted-foreground">{language === "ru" ? member.roleRu : member.roleEn}</p>
              </motion.article>
            </HoverNote>
          ))}
        </div>
