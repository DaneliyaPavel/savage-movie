...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    "studio.service1.desc": "Полный цикл продакшна для брендов, ищущих премиальный визуальный контент.",
    ...
    "studio.testimonial1": "Работа с Savage подняла наш бренд-фильм на уровень, о котором мы даже не мечтали.",
    "studio.testimonial2":
    ...
    "courses.title": "Курсы",
    "courses.subtitle": "Передаём опыт создания премиального контента. От съёмки до AI — учитесь у практиков.",
    ...
    "contact.subtitle": "Давайте обсудим ваше видение. Расскажите о проекте, и мы свяжемся с вами в течение 24 часов.",
    "contact.name": "Имя",
  ...
  en: {
    ...
    "studio.testimonial1": "Working with Savage elevated our brand film beyond anything we imagined.",
    "studio.testimonial2": "They bring a cinematic sensibility that's rare in commercial production.",
    ...
    "contact.messagePlaceholder": "Describe your vision, timeline, and any specific requirements...",
